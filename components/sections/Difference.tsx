...
const CASE_STUDIES = [
  ...
  },
  {
    ...
    caption: "Duqm Refinery, Oman · Detailed Engineering · LOD 500",
    title: "A refinery, modelled to fabrication detail",
    body: "Process and utility systems for a major refinery development, delivered for PETROFAC to LOD 500. Detailed 3D models gave the disciplines fabrication-ready coordination before work reached site.",
    cta: "View projects",
    href: "/projects",
  },
];
